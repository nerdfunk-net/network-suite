...
app.secret_key = "your-secret-key-change-this"  # Change this in production
        ...
        logger.info(f"Adding device to Nautobot: IP={ip_address}, Location_ID={location_id}, Role_ID={role_id}")k(__name__)
app.secret_key = "your-secret-key-change-this"  # Change this in production
...
def get_nautobot_namespaces() -> list[dict[str, any]]:
    ...
    Returns:
        List of namespace dictionaries with 'id' and 'name' keys.
        
    Raises:
        Exception: If unable to query Nautobot namespaces.
    """
    try:
        query = """
        query namespace {
...
def get_nautobot_roles() -> list[dict[str, any]]:
    ...
    Returns:
        List of role dictionaries with 'id' and 'name' keys.
        
    Raises:
        Exception: If unable to query Nautobot roles.
    """
    try:
        query = """
        query roles {
...
def get_nautobot_platforms() -> list[dict[str, any]]:
    ...
    Returns:
        List of platform dictionaries with 'id' and 'name' keys.
        
    Raises:
        Exception: If unable to query Nautobot platforms.
    """
    try:
        query = """
        query platforms {
...
def get_nautobot_statuses() -> list[dict[str, any]]:
    ...
    Returns:
        List of status dictionaries with 'id' and 'name' keys.
        
    Raises:
        Exception: If unable to query Nautobot statuses.
    """
    try:
        query = """
        query status {
...
def get_nautobot_secrets_groups() -> list[dict[str, any]]:
    ...
    Returns:
        List of secrets group dictionaries with 'id' and 'name' keys.
        
    Raises:
        Exception: If unable to query Nautobot secrets groups.
    """
    try:
        query = """
...
def add_device_to_nautobot(ip_address: str, location_id: str, secret_groups_id: str, role_id: str, namespace_id: str, status_id: str, platform_id: str) -> dict[str, any]:
    ...
    try:
        ...
        print(data)
        logger.info(f"Adding device to Nautobot: IP={ip_address}, Location_ID={location_id}, Role={role}")
...
def onboard_device():
    ...
    return render_template("onboard_device.html", ip_address=ip_address, locations=locations)
